...
root = Tk()
root.title("Welcome to Stock Management System")
...
def Exit():
    result = tkMessageBox.askquestion('Stock Management System', 'Are you sure you want to exit?', icon="warning")
    if result == 'yes':
        root.destroy()
        exit()
...
def ShowLoginForm():
    global loginform
    loginform = Toplevel()
    loginform.title("welcome to Stock Management System/Account Login")
    width = 700
    height = 500
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
...
def Home():
    global Home
    Home = Tk()
    Home.title("welcome to Stock Management System/Home")
    width = 980
    height = 700
    ...
    Title.pack(pady=10)
    lbl_display = Label(Title, text="welcome to Stock Management System", font=('calibri', 40))
    lbl_display.pack()
    menubar = Menu(Home)
...
def ShowAddNew():
    global addnewform
    addnewform = Toplevel()
    addnewform.title("Stock Management System/Add new")
    width = 600
    height = 500
    screen_width = Home.winfo_screenwidth()
    screen_height = Home.winfo_screenheight()
...
def AddNewForm():
    ...
    lbl_text = Label(TopAddNew, text="Add New Product", font=('arial', 24), width=600)
    lbl_text.pack(fill=X)
...
def ViewForm():
    ...
    lbl_text = Label(TopViewForm, text="View Products", font=('arial', 30), width=600)
    lbl_text.pack(fill=X)
    lbl_txtsearch = Label(LeftViewForm, text="Search", font=('arial', 30))
    lbl_txtsearch.pack(side=TOP, anchor=W)
    search = Entry(LeftViewForm, textvariable=SEARCH, font=('arial', 30), width=10)
...
def Delete():
    if not tree.selection():
       print("ERROR")
        ...
        result = tkMessageBox.askquestion('Stock Management System', 'Are you sure you want to delete this record?', icon="warning")
        if result == 'yes':
            curItem = tree.focus()
...
def ShowView():
    global viewform
    viewform = Toplevel()
    viewform.title("Stock Management System/View Product")
    width = 800
    height = 700
    screen_width = Home.winfo_screenwidth()
    screen_height = Home.winfo_screenheight()
...
def Logout():
    result = tkMessageBox.askquestion('v', 'Are you sure you want to logout?', icon="warning")
    if result == 'yes': 
        admin_id = ""
        root.deiconify()
        Home.destroy()
...
#========================================LABEL WIDGET=====================================
lbl_display = Label(Title, text="Stock Management System", font=('arial', 45))
lbl_display.pack()
